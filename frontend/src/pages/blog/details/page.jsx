        ...
        <div className="p-5 mx-auto sm:p-10 md:p-16  dark:text-gray-100">
          <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
            <img
              ...
              alt=""
              className="w-full h-80 sm:h-96 dark:bg-gray-500"
            />
            <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md ">
              <div className="space-y-2 bg-indigo-700 rounded-lg py-4 px-4">
                <h1
              ...
              <div className="bg-gray-100 py-4  rounded-lg">
                ...
                />
                <div className="w-full  bg-indigo-700 border border-gray-200 rounded-lg shadow  mt-20">
