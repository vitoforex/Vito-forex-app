...
const Page = () => {
  ...
  return (
    ...
    {/*new login*/}
    <div className="pt-20 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-10 flex items-center justify-center" to="/">
                <img className="hidden dark:block h-20 w-20" src={Logo} alt="Logo"/>
               <span className="font-bold ml-2 text-4xl">Vito Forex</span>
              </Link>

              <p className="2xl:px-20 mb-10">
                Welcome back to Vito Forex.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            ...
            <Link to={'/'}>
              <span className="mb-1.5 block font-medium text-primary underline underline-offset-2">Back</span>
            </Link>
              <h2 className="mb-9 text-2xl font-bold text-black  sm:text-title-xl2">
                Sign In to Vito Forex
              </h2>
              ...
              <form onSubmit={handleSubmit(onSubmitHandler)}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input  {...register("email")} type="email" placeholder="Enter your email" className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"/>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input {...register("password")} type="password" placeholder="8+ Characters" className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"/>
